  ...
  <div class="container">
    <main>
      <div class="py-5 text-center">
        <a href=""><img class=" mx-auto mb-4" src="assets/img/favicon2.png" alt="" width="100" height="70"></a>
		<h2>COUSIÑAS 24H<h2/>
		<br>
        <h2>Tu pago ha sido realizado correctamente</h2>
        <br>
        <img class=" mx-auto mb-4" src="assets/img/check.png" alt="" width="70" height="70">
        <br>
        </div>
    ...
    <p><strong>Dirección 2:</strong> <?php echo $direccion2; ?></p>
    <p><strong>País:</strong> <?php echo $pais; ?></p>
    <p><strong>Provincia:</strong> <?php echo $provincia; ?></p>
    <p><strong>Código Postal:</strong> <?php echo $zip; ?></p>
...
<br>
    ...
    <p>Apreciamos tu confianza en nosotros. Si tienes alguna pregunta o inquietud, no dudes en ponerte en 
